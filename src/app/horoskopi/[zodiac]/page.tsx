...
const page = ({ params }: props) => {
    ...
    const getZodiacDetail = async () => {
        await zodiacServices.getZodiacDetail(setZodiac, "general", zodiacName);
        await zodiacServices.getZodiacDetail(setZodiac, "love", zodiacName);
        await zodiacServices.getZodiacDetail(setZodiac, "finance", zodiacName);
        await zodiacServices.getZodiacDetail(setZodiac, "sexual", zodiacName);
    };
