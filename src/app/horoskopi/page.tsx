    ...
    return (
        <section className="md:px-4 md:py-4 xxl:px-7 xxl:py-5 xxl:rounded-[34px] pb-[100px] lg:pb-0 md:rounded-[26px] bg-[#a7aec727] dark:bg-[#355a716b] w-full h-full relative overflow-hidden flex flex-col xxl:gap-24 md:gap-16">
            ...
            <div className="flex items-center justify-center md:pt-10 xxl:pt-16 relative ">
                <h1 className="text-center mb-[50px] md:mb-0 text-[30px] md:text-5xl font-light bg-gradient-to-b dark:from-blue-400  from-[#2E386B] dark:to-white bg-clip-text text-transparent flex flex-col md:gap-4 xxl:gap-6 pl-10">
