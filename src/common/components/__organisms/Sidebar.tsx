...
const Sidebar = () => {
  ...
  return (
    <aside className="md:w-[80px] xxl:w-[120px] h-full flex flex-col items-center justify-between bg-[#cea9a927] xxl:rounded-[34px] md:rounded-[26px] p-[80px_0_40px] relative overflow-hidden">
