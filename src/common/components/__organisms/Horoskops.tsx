...
const Horoskops = () => {
    ...
    return (
        <article className="grid grid-cols-2 md:gap-x-4 xxl:gap-x-16 xxl:gap-y-20 gap-y-[50px] md:gap-y-[30px] sm:grid-cols-3 sm:gap-y-[40px] md:grid-cols-4 lg:grid-cols-6 w-[80%] mx-auto ">
