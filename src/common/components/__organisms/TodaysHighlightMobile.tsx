...
const TodaysHiglightsMobile = () => {
  ...
  return (
    <section className="rounded-[34px] max-w-[378px] w-full relative overflow-hidden flex flex-col gap-2 h-full">
      {/* <div
      ...
      <div className="flex flex-col h-full gap-14 max-w-[378px] w-full">
        <HighlightUpperMobile
          props={windStatus}
          type="windStatus"
          className="col-start-1 col-end-3 row-start-1 row-end-3 h-[178px]"
