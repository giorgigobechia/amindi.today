...
import DetailedDayForecastIcon from "@/common/icons/detailedDayForecastIcon";
import React from "react";

const DetailedDayForecast = () => {
  return (
    <div className="w-full h-[40%] flex items-center justify-between bg-[#ffffff7f] rounded-[18px] px-[18px]">
